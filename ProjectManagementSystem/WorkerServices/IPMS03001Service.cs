#region License
/// <copyright file="IPMS03001Service.cs" company="i-Enter Asia">
...
namespace ProjectManagementSystem.WorkerServices
{
    ...
    /// Service interface
    /// </summary>
    public interface IPMS03001Service
    {
        /// <summary>
        ...
        PageInfo<ContractTypePlus> Search(DataTablesModel model, string companyCode, Condition condition);
