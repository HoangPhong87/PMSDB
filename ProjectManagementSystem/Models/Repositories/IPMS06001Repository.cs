#region License
/// <copyright file="IPMS06001Repository.cs" company="i-Enter Asia">
...
namespace ProjectManagementSystem.Models.Repositories
{
    ...
    /// </summary>
    public interface IPMS06001Repository
    {
        /// <summary>
        ...
        /// <returns>List of category</returns>
        IEnumerable<ContractTypeCategory> GetDefaultCategoryListByContract(string companyCode, int contractTypeId);
        ...
        /// <param name="condition"></param>
        /// <returns></returns>
        PageInfo<dynamic> GetUserWorkTimeByPhase(int startItem,
            int itemsPerPage,
            string columns,
            int? sortCol,
            string sortDir,
